...
public class DetailPlaceInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String p_image;
        if(placeInfo.get(0).getPlace_img_like() ==null) {
            Uri uri = Uri.parse("android.resource://com.example.appdevelopment/drawable/no_image");
            Log.d("CHECK URI", "Uri uri = "+uri);
            try {
                InputStream stream = getContentResolver().openInputStream(uri);
            } catch (FileNotFoundException e) {
                e.printStackTrace();
            }
            //p_image = "content://com.google.android.apps.photos.contentprovider/-1/1/content%3A%2F%2Fmedia%2Fexternal%2Fimages%2Fmedia%2F81/ORIGINAL/NONE/image%2Fjpeg/1568261137";
            p_image = "android.resource://com.example.appdevelopment/drawable/no_image";
        }else {
           Uri uri = Uri.parse("android.resource://com.example.appdevelopment/drawable/no_image");
            Log.d("CHECK URI", "Uri uri = "+uri);
            p_image = placeInfo.get(0).getPlace_img_like();
        }
        ...
        ImageView p_image_q = (ImageView) findViewById(R.id.custom_detailpage_image);
        ...
        p_image_q.setImageURI(Uri.parse(p_image));
        ...
        addWish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!check.equals(placename)){
                    ...
                    String place_img = Login.connect.placesDAO().getPlacesImage(placename);

                    Wishlist wishlist = new Wishlist();
                    wishlist.setUsername(username);
                    wishlist.setPlace_name(placename);
                    wishlist.setPlace_img(place_img);
